...
class DocTitleUnderOccupation(TimestampMixin, Base):
  __tablename__ = "doc_title_under_occupation"
  __table_args__ = (
  ...
  title_holder_name: Mapped[str | None] = mapped_column(String(255))
  ...
  title_address_full: Mapped[str | None] = mapped_column(Text)
  ...
  title_land_area_measure: Mapped[str | None] = mapped_column(String(100))
  ...
  document: Mapped["MasterDocument"] = relationship(back_populates="title_under_occupation")
